...
const replaceWords = (str) => {
    ...
    let indexI = arr.indexOf("I");
    arr.splice(indexI, 1,"We");
    let indexAm = arr.indexOf("am");   
    arr.splice(indexAm, 1, "are");
    let indexWas = arr.indexOf("was");    
    arr.splice(indexWas, 1, "were");
    
   let str1 = str.split(" ");
   arr.splice(arr.length-1, 1, str1[str1.length-1]);
   let newStr= arr.join(" ");
 return newStr; 
}
    // -------------------------------------------------------------------------------------------------------
